...
c6.pack()
ch1=Checkbutton(root,text="Bihar")
ch1.pack()
ch2=Checkbutton(root,text="Bihar")
ch2.pack()
ch3=Checkbutton(root,text="Bihar")
ch3.pack()
ch4=Checkbutton(root,text="Bihar")
ch4.pack()"""

lst=Listbox(root,selectmode='select')
lst.insert(1,"Bihar")
lst.insert(1,"Uttarakhand")

lst.insert(1,"Jharakhand")
lst.insert(1,"Uk")
lst.pack()
